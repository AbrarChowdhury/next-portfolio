          ...
          subProjects: [
            {
              ...
              description: "A WebXR app designed to train teachers by simulating interactions with a virtual child in a childcare setting, allowing educators to practice and improve their skills in handling various emotional scenarios.",
            ...
            },
            {
              ...
              description: "Mindbloom AI helps bridge the training and practice gap for managers by providing a scalable and accessible practice environment for difficult conversations, such as performance reviews and workplace disputes.",
              role: {
      ...
      projects: [
        {
          ...
          description: "Bioforge HMS (Hospital Management System) is an integrated solution designed to streamline hospital operations, enhance patient care, and improve overall efficiency. It includes various modules such as discharge, lab, appointment, and statistics, each tailored to address specific aspects of hospital management.",
          role: {
          ...
          subProjects: [
            {
              ...
              iconList: virtyouTechList,
              description: "The HMS-Discharge Module is part of a comprehensive hospital management system designed to streamline the discharge process for patients. It ensures accurate and efficient handling of discharge procedures, including documentation and coordination with other hospital departments.",
              role: {
            ...
            },
            {
              ...
              iconList: virtyouTechList,
              description: "The HMS-Lab Module manages the laboratory operations within the hospital, including test orders, results, and lab workflows.",
              role: {
            ...
            },
            {
              ...
              iconList: virtyouTechList,
              description: "The HMS-Statistics Module provides comprehensive data analytics and reporting tools for hospital management, aiding in decision-making and performance evaluation.",
              role: {
            ...
            },
            {
              ...
              iconList: virtyouTechList,
              description: "The HMS-Appointment Module facilitates the scheduling and management of patient appointments, improving the efficiency of hospital operations.",
              role: {
        ...
        },
        {
          ...
          description: "The Vital Sign Monitor project involves the development of a cost-effective solution for real-time remote monitoring of patients' vital signs.",
          role: {
